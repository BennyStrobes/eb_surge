...
n_pcs="$7"
old_standard_eqtl_results_file="$8"
...
python extract_variant_gene_pairs_to_test_for_standard_eqtl_analysis.py $old_standard_eqtl_results_file $qtl_test_names_file
